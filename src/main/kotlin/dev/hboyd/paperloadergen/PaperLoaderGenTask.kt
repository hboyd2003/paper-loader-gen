...
abstract class PaperLoaderGenTask : DefaultTask() {
    ...
    @TaskAction
    fun generate() {
        val className: String = classPath.get().substringAfterLast('.')
        val packageName: String = classPath.get().substringBeforeLast('.')
                ...
                writer.format(
                    ...
                    public final class %s implements PluginLoader {
                        ...
                        public void classloader(@NonNull PluginClasspathBuilder classpathBuilder) {
                            ...
                            resolver.addRepository(new RemoteRepository.Builder("maven-central", "default", resolver.MAVEN_CENTRAL_DEFAULT_MIRROR).build());
                """.trimIndent(),
                    packageName,
